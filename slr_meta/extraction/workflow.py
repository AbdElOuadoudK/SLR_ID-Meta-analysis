...
from slr_meta.extraction.export import export_extracted
from slr_meta.extraction.io_utils import load_csv
from slr_meta.extraction.s2 import enrich_extract

from slr_meta.shared.paths import (
...
def main(argv: list[str] | None = None) -> None:
    ...
    from slr_meta.sheets.builder import build_template_with_data
